  ...
  const STRINGS = {
    en: {
      ...
      life: {
        ...
        reseed: "Reseed",
        clear: "Clear",
        hint: "↑ click & drag the board to plant your own little colonies",
      },
      films: {
    ...
    de: {
      ...
      life: {
        ...
        reseed: "Neu säen",
        clear: "Leeren",
        hint: "↑ Klicke und ziehe übers Feld, um eigene Kolonien zu setzen",
      },
      films: {
    ...
    es: {
      ...
      life: {
        ...
        reseed: "Resembrar",
        clear: "Limpiar",
        hint: "↑ Haz clic y arrastra para sembrar tus propias colonias",
      },
      films: {
    ...
    bar: {
      ...
      hero: {
        ...
        splitDesc: "A ctrategicbui mid lebendign zein fia'n umcauga und's vickastl. Lás kolonin vágsn, ibalist's gita.",
        splitCta: "▶ Cbui um sunst",
        scroll: "Óbe",
        ticker_html: [
          "✦ <b>Teem</b> — iads im umcauga und af'm vickastl",
          "✦ Animiade boarice gcihdn — <b>in da veakcdód</b>",
          "✦ Ctrategicbui mid a sakricn gcpas",
          "✦ Boarice biaha — <b>in da veakcdód</b>",
          "✦ Gmáhd in de foaóipm, <b>mid am dutal boaricn gcpas</b>",
        ],
      },
      teem: {
        pills: { live: "Iads sendma", browser: "Umcauga", mobile: "Vickastl", strategy: "Ctrategi" },
        eyebrow: "Unsa easts cbui",
        desc: "A hándlihs ctrategicbui, vo'sd kolonin fo lebendige dsein afdsiagsd. Insbiriad fo da matematik fo'm Conway sei \"Cbui fom Lém\" — iéda dsug dsiagd seine ring, und as gita is óivai blos an átmdsug veg fom kaos.",
        feats: [
          "Bflands, cnaid und lenk seibsdoaganisiade dseikolonin.",
          "An iédn dóg naie rédsl und a endlose sándkisdn.",
          "Mid oam dama dsum cbuin — ivaroi, nix instalian.",
        ],
        ctaPlay: "▶ Im umcauga cbuin",
        ctaMobile: "Af's vickastl hoin",
      ...
      life: {
        ...
        reseed: "Nai sén",
        clear: "Leean",
        hint: "↑ Klick und dsiag's brett, um dei aiagne kolonin dsum sén",
      },
      films: {
        eyebrow: "In da veakcdód",
        title_html: "Gcihdn af <em>Boaric</em> <span class=\"am\">✦</span>",
        lead: "Mia máha kuatse animiade fuim fia kinda — facbuide, heatsveamade gcihdn af boaric, damid de sei fo am foik fia de négsde genaradsion lebendig blaibd.",
        featBadge: "Kumd bóid",
        featTitle: "Da Beni",
        featDesc: "Da murme Beni dsoagd sei veit.",
        cards: [
          { k: "Serie 4–9 iór", h: "Ehds Boaric gret", p: "Ehde cbráh, gcrim und gret fo am muatacbráhla — damid de gloana de veata leanea, mid dene eane grouseitan grous voan han." },
          { k: "Foamat", h: "Dutal lánge fuim", p: "Hándgmáhde kuatsfuim, ié 4–6 minutn. Gmáhd fia's bet, fia's glasndsima und fia naigiarige námidóg." },
      ...
      books: {
        ...
        eyebrow: "Unsa easts buah",
        byline: "fom Mátias Craiba",
        paras: [
          "As Vestrémice Raih brihd asanánd an da Donaugrents — fo a tsámfoinde festung, végslnde trai und gcvats fom griag máha as lém cvar an iédn dóg. Da Cassius is no a bua, áva óid gnua um dsum séng, das as gseds fo Rom nima bis af seine grentsn lángd, und das da glam — oid und nai — a doaf ainigd oda asanánda raisn ko.",
          "Ven de gvóid endlih ivakohd, vead da Cassius as'm oandsign dahoam grisn, vos'a ié kend hód, und in a gfarlihe roas duah's grentslánd gcmisn vead — vo hunga, politik und cveata heacn. Unta'n cuts fom Severinus, an vándandn hailign mit am vundasáman ruaf, vead da Cassius in an kámpf eitsong, dea greisa is óis iéds cláhdfeid: facrekte laid am lém hóitn, a gmoacáfd dsámahóitn, ven's asandándabrihd, und de gnad vein, ven de fuahd náh grausamkait ruaft.",
          "Ven da vinta kumd und de feint si sámen, muas da Cassius cneia grous vean ois a kind soit — leana, vós fian hoast, ven's koa raih mea gibd, af des ma si falásn ko, und sigd, das da heatasde kámpf ned gégan eidringling foa de toa is, sundan gága de fadsvaiflung in de mauan.",
        ],
        tag: "A historica romaan iba's eaváksn vean — iba an glam, de ceam, und an brais fo de trima fo Rom vás nais af dsum baun.",
      ...
      studio: {
        ...
        para1_html: "Mia han a gloans, unábhengigs cdudio aus de foaóipm und máha <strong>ctrategicbui</strong>, <strong>animiade fuim</strong> und <strong>romaane</strong>. Mia mégn iden, de af'm eastn blik oafáh ascaugn und um so lenga ma blaibd, desto diafa veans.",
        ...
        values: [
          { t: "Gloa und dsakig", d: "A gloane máncáfd, de ehde sáhan rausbringd, koane végvaisa." },
          { t: "Pfifig entvoafa", d: "Oafáhe regln, diafs cpui — sistem de uns seiba ibarácn." },
      ...
      follow: {
        ...
        title_html: "Griag's ds'east dsum ségn <span class=\"am\">✦</span>",
