  ...
  const STRINGS = {
    ...
    bar: {
      ...
      teem: {
        ...
        desc: "A hándlihs ctrategicbui, vo'sd kolonin fo lebendige zein afdsiagsd. Insbiriad fo da matematig fo'm Conway sei \"Cbui fom Lém\" — iéda dsug dsiagd seine ring, und es gita is óivai blos an átmdsuag veg fom kaos.",
        feats: [
      ...
      books: {
        ...
        paras: [
          ...
          "Ven de gvóid endlih ivakohd, vead da Cassius as'm oandsign dahoam grisn, vo ea ié kend hód, und in a gfarlihe roas duah's grentslánd gcmisn — vo hunga, politik und cveata heacn. Unta'n cuts fom Severinus, an vándandn hailign mit am vundasáman ruaf, vead da Cassius in an kámpf eitsong, dea greisa is óis iéds cláhdfeid: facrekte laid am lém hóitn, a gmoacáfd dsámahóitn, ven's asandándabrihd, und de gnad vein, ven de fuahd náh grausamkait ruaft.",
          "Ven da vinta kumd und de feint si sámen, muas da Cassius cneia grous vean ois a kind soit — leana, vós fian hoasd, ven's koa raih mea gibd, af des ma si falásn ko, und sigd, das da heatasde kámpf ned gégan eidringling foa de toa is, sundan gágan de fadsvaiflung in de mauan.",
        ],
        tag: "A historica romaan iba's eaváksn vean — iba an glaum, de ceam, und an brais fo de trima fo Rom vás nais af dsum baun.",
      ...
      studio: {
        ...
        values: [
          { t: "Gloa und dsakig", d: "A gloane máncáfd, de ehde sáhan rausbringd, koana végvaisa." },
